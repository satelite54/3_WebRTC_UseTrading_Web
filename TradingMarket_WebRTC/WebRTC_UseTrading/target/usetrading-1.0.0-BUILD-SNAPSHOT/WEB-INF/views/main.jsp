	...
	<div id="carouselExampleIndicators" class="carousel slide w-60"
		...
		<div class="carousel-inner">
			...
			<div class="carousel-item">
				<img class="d-block w-100"
					src="${pageContext.request.contextPath}/resources/img/caresel2.jpg??auto=yes&bg=666&fg=444&text=Second slide"
					alt="Second slide">
			</div>
			<div class="carousel-item">
				<img class="d-block w-100"
					src="${pageContext.request.contextPath}/resources/img/caresel3.jpeg??auto=yes&bg=555&fg=333&text=Third slide"
					alt="Third slide">
			</div>
		</div>
